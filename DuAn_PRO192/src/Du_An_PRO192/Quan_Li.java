		...
		if(ketquatimkiem.isEmpty()) {
			...
			try 
				...
				for (Giang_Vien giang_Vien : ketquatimkiem) {
					fw.write("Tên: " + giang_Vien.getTen() +   "   Email:" + giang_Vien.getEmail()+    "   Môn Dạy: " + giang_Vien.getMon_Giang_Day()+"\n");
				}
			...
			try (FileWriter writer = new FileWriter(tenFile)) {
				for (Giang_Vien giang_Vien : ketquatimkiem) {
					writer.write("Tên: " + giang_Vien.getTen() +   "   Email: " + giang_Vien.getEmail()
							+   "   Chuyên Ngành: " + giang_Vien.getMon_Giang_Day() + "\n");
				}
		...
		if(ketQuaTimKiem.isEmpty()) {
			...
			try 
				...
				for (Sinh_Vien sinh_Vien : ketQuaTimKiem) {
					fw.write("Tên: " + sinh_Vien.getTen() +   "   Email:" + sinh_Vien.getEmail()+    "   Môn Dạy: " + sinh_Vien.getChuyen_Nganh()+"\n");
				}
			...
			try (FileWriter writer = new FileWriter(tenFile)) {
				for (Sinh_Vien sinh_Vien : ketQuaTimKiem) {
					writer.write("Tên: " + sinh_Vien.getTen() +   "   Email: " + sinh_Vien.getEmail()
							+   "   Chuyên Ngành: " + sinh_Vien.getChuyen_Nganh() + "\n");
				}
