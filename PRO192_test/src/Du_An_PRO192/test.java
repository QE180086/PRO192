...
public static void main(String[] args) {
	...
	do {
		...
		if(luachon==1) {
			...
			ql.timKiemGiangVien_MonDay(mon_day);
		} else if (luachon ==4 ) {
			System.out.println("Nhap email de tim giang vien : ");
			String email = sc.nextLine();
			ql.timKiemGiangVien_Email(email);
		} else if (luachon ==5) {
			...
			System.out.println("Nhap ten: "); String ten = sc.nextLine();
			System.out.println("Nhap email: "); String email = sc.nextLine();
			System.out.println("Nhap mon day: "); String chuyen_nganh = sc.nextLine();
